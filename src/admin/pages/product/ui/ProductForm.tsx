          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    />
                   {
                    errors.price &&  (<p className=' text-red-500 text-sm'> El precio debe ser mayor que cero</p>)
                  }
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      />
                      {
                    errors.stock &&  (<p className=' text-red-500 text-sm'> El stock debe ser mayor que cero</p>)
                  }
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register('slug',{
                        required: true,
                        validate: (value) => !/\s/.test(value) || 'El slug no puede contener espacios en blanco, usar guion bajo como separador.'
                     })}
                     className={
                        cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",{
            ...
            <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
              ...
              <div className="space-y-4">
                ...
                {
                    selectedSizes.length === 0  && <p>No hay tallas disponibles</p>
                }
